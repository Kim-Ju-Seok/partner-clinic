...
function renderHomePage() {
  return `
  <div id="main_visual">
    <video src="http://partneros.kr/video/mv.mp4" autoplay muted loop playsinline></video>
  </div>
  <div class="wrap" id="ma">
    ...
    <dl class="dlw js">
      <dd><a href="#page=2_1" onclick="navigateTo('2_1')"><i><img src="http://partneros.kr/img/ma_icon1.png" alt="미세침습 수술클리닉"></i>
          <p>미세침습<br>수술클리닉</p>
        </a></dd>
      <dd><a href="#page=3_1" onclick="navigateTo('3_1')"><i><img src="http://partneros.kr/img/ma_icon2.png" alt="비수술 클리닉"></i>
          <p>비수술<br>클리닉</p>
        </a></dd>
      <dd><a href="#page=4_1" onclick="navigateTo('4_1')"><i><img src="http://partneros.kr/img/ma_icon3.png" alt="척추·관절 클리닉"></i>
          <p>척추·관절<br>클리닉</p>
        </a></dd>
      <dd><a href="#page=5_1" onclick="navigateTo('5_1')"><i><img src="http://partneros.kr/img/ma_icon4.png" alt="도수·물리치료 클리닉"></i>
          <p>도수·물리치료<br>클리닉</p>
        </a></dd>
    </dl>
  </div>
  ...
  <div class="wrap" id="mb">
    <dl class="dlw js br">
      <dt class="vc">
        <figure><img src="http://partneros.kr/img/mb_img.png" alt="파트너 정형외과"></figure>
      </dt>
      <dd>
        ...
        <dl class="dlw js">
          ...
          <dt class="vc"><i><img src="http://partneros.kr/img/next_icon.png" alt="다음"></i></dt>
          <dd><strong>2</strong>
            <p>영상학적<br>검진</p>
          </dd>
          <dt class="vc"><i><img src="http://partneros.kr/img/next_icon.png" alt="다음"></i></dt>
  ...
  <div class="wrap" id="mc">
    <dl class="dlw js">
      ...
      <dt class="vc">
        <figure><img src="http://partneros.kr/img/mc_img.png" alt="통증 치료 단계"></figure>
      </dt>
    </dl>
  </div>

  <div class="wrap" id="md">
    <i><img src="http://partneros.kr/img/logo_icon.svg" alt="로고 아이콘"></i>
